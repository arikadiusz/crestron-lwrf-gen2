...
namespace crestron_lwrf_gen2
{
    ...
    {
        public static void lightwaveRfRoomAllOn(string roomName, string zoneName, HTTPSClientResponseCallback response)
        {
            try
            {
            ...
            {
                ErrorLog.Error("Exception in LwrfGen2.lightwaveRfRoomAllOn, Message : {0}", exc.Message);
            }
        }
    }
}
