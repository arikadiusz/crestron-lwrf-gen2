...
namespace crestron_lwrf_gen2
{
    ...
    {
        public static void lightwaveRfRoomLoadOn(string roomName, string zoneName, int loadNum, HTTPSClientResponseCallback response)
        {
            try
            {
            ...
            {
                ErrorLog.Error("Exception in LwrfGen2.lightwaveRfRoomLoadOn, Message : {0}", exc.Message);
            }
        }
    }
}
